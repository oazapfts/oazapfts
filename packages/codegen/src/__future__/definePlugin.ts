...
export class Hooks {
   ...
   */
  public cliValidateArgs = new AsyncSeriesHook<[CliContext]>(
    ["context"],
    "cliValidateArgs",
  );
  /**
   ...
   */
  public oasPrefetch = new AsyncSeriesHook<[CliContext]>(
    ["context"],
    "oasPrefetch",
  );
  /**
  ...
  >(["defaults", "fullTree", "document", "context"], "tsModifyDefaults");
  /**
  ...
  >(["servers", "fullTree", "document", "context"], "tsModifyServers");
  ...
  >(["schema", "fullTree", "document", "context"], "convertEndpointBefore");
  ...
  >(["schema", "fullTree", "document", "context"], "convertSchemaBefore");
  ...
  >(["typeTree", "schema", "fullTree", "document", "context"], "convertSchema");
  ...
  >(["fullTree", "document", "context"], "astGenerated");
  ...
  >(["fileName", "fileContents", "document", "context"], "writeFileBefore");
...
export type Callback = (hooks: Hooks) => Promise<void>;

export let __globalHooks = new Hooks();

export function __updateGlobalHooks(hooks: Hooks) {
  __globalHooks = hooks;
}

export async function defineOazapftsPlugin(plugin: Callback): Promise<void> {
