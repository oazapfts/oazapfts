...
export function updatePetWithForm(petId: number, body: {
    ...
    return oazapfts.ok(oazapfts.fetchText(`/pet/${petId}`, oazapfts.form({
        ...opts,
        method: "POST",
        body
    })));
...
export function deletePet(petId: number, { apiKey }: {
    ...
    return oazapfts.ok(oazapfts.fetchText(`/pet/${petId}`, {
        ...opts,
        method: "DELETE",
        headers: {
            ...opts && opts.headers,
...
export function deleteOrder(orderId: number, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/store/order/${orderId}`, {
        ...opts,
        method: "DELETE"
    }));
}
...
export function createUsersWithArrayInput(body: User[], opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText("/user/createWithArray", oazapfts.json({
        ...opts,
        method: "POST",
        body
    })));
...
export function createUsersWithListInput(body: User[], opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText("/user/createWithList", oazapfts.json({
        ...opts,
        method: "POST",
        body
    })));
...
export function logoutUser(opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText("/user/logout", {
        ...opts
    }));
}
/**
...
export function updateUser(username: string, user: User, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/user/${username}`, oazapfts.json({
        ...opts,
        method: "PUT",
        body: user
    })));
...
export function deleteUser(username: string, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchText(`/user/${username}`, {
        ...opts,
        method: "DELETE"
    }));
}
export function customizePet({ furColor, color, xColorOptions }: {
    ...
    return oazapfts.ok(oazapfts.fetchText(`/pet/customize${QS.query(QS.form({
        "fur.color": furColor,
        color
    }))}`, {
        ...opts,
